...
def n2v_train(model_base_dir, channel):
	...
	train_imgs = join(model_base_dir, 'train_imgs')
	imgs = datagen.load_imgs_from_directory(directory=train_imgs, dims='YX')
	# Split each training image into 3D patches that will be used either for the training or the validation
	...
	# Split the patches into a training and a validation (used to evaluate how the model improves) set
